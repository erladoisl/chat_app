		...
		<div className="HomePage container">
			{isLoading || isAuthLoading ? (
				...
				<div className='row justify-content-center'>
					<Card className='col-lg-5 col-sm-6 col-11 p-0'>
						<Card.Header className='bg-white text-center mb-3'>
						...
						{chats.map(chat => (
							<div className='container m-1' key={chat.uuid}>
								<div className='row'>
									<div className='col'>
										<a className='text-decoration-none' href={`/chat/${chat.uuid}`}>
											<div className='container rounded chatItem'>
												<div className='row '>
						...
						<Form onSubmit={submitCreateChat} className='mb-3'>
